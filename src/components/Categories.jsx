...
function Categories() {
  ...
  return (
    <div className="my-10 w-9/12 mx-auto space-y-8">
      ...
      <div className="categories flex flex-wrap justify-between">
        {categories.map((cat, ind) => (
          <div
            ...
            className="relative transition duration-150 ease-in-out cursor-pointer hover:scale-110 p-2 md:p-5 flex items-end justify-center mt-4 w-36 h-36 md:w-64 md:h-64 category overflow-hidden rounded-lg"
          >
