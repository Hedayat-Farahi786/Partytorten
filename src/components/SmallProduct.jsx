...
function SmallProduct() {
  return (
    <div className="flex space-x-2">
        <img className="w-20 h-20 object-cover" src="https://d-themes.com/wordpress/riode/demo-1/wp-content/uploads/sites/5/2020/09/product-9-1-267x300.jpg" alt="product" />
